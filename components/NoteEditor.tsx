...
import { SparklesIcon, MicrophoneIcon, StopIcon, PaperClipIcon, ArrowLeftIcon, TrashIcon, TagIcon, UserIcon, XMarkIcon, CameraIcon } from './icons';
...
const NoteEditor: React.FC<NoteEditorProps> = ({ note, updateNote, deleteNote, onClose, masterPeopleList, onAddPersonToMasterList, onOpenCamera }) => {
  ...
  return (
    <div className="flex-1 bg-[#1C1C1C] text-white flex flex-col">
       <div className="sticky top-0 z-10 bg-[#1C1C1C] pt-10 pb-3 px-6 border-b border-gray-800 flex items-center justify-between">
