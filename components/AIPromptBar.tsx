...
const AIPromptBar: React.FC<AIPromptBarProps> = ({ onAskAI, isLoading, aiResponse, clearResponse }) => {
  ...
  return (
    <div className="bg-[#111111] pt-3 px-3 border-t border-gray-800 fixed bottom-0 left-0 right-0 z-40" style={{ paddingBottom: 'calc(0.75rem + env(safe-area-inset-bottom))' }}>
